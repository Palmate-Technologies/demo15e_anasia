...
class AccountChartTemplate(models.Model):
    ...
    def _prepare_all_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        if self == self.env.ref('l10n_sa_anasia.anasia_chart_template_standard'):
    ...
    def _load_template(self, company, code_digits=None, account_ref=None, taxes_ref=None):
        ...
        if self == self.env.ref('l10n_sa_anasia.anasia_chart_template_standard'):
            ...
            if ifrs_journal_id:
                ifrs_account_ids = [self.env.ref('l10n_sa_anasia.anasia_account_160000').id,
                                    self.env.ref('l10n_sa_anasia.anasia_account_170011').id,
                                    self.env.ref('l10n_sa_anasia.anasia_account_720018').id]
            ...
            if zakat_journal_id:
                zakat_account_ids = [self.env.ref('l10n_sa_anasia.anasia_account_250002').id,
                                    self.env.ref('l10n_sa_anasia.anasia_account_910001').id]
